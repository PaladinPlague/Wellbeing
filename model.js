...
class Model {
  ...
  constructPostDetailsContent(currentPostObj) {
    let currentPostContent = "<div class='details'><p id='textdetail'>";
    ...
    currentPostContent += "<p id='title'>Comments:</p><div id='comments_container'>";
  ...
  constructCommentContent(currentCommentObj) {
    let currentCommentContent = "<div id='commenters'>" + currentCommentObj.username + " | " + currentCommentObj.text + " | <p id='small'>" + currentCommentObj.timestamp + "</p></div>";
